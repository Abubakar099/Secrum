...
export default function CartDrawer({
  ...
  const completeCheckout = () => {
    if (validatePayment()) {
      // Create random invoice reference code
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          {/* Frosted elegant ambient overlay */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.5 }}
            exit={{ opacity: 0 }}
          ...
          >
                  ...
                  {cartItems.length === 0 ? (
                    ...
                    <div className="space-y-6">
                      {cartItems.map((item) => (
                        ...
                        >
                          <div className="w-20 h-24 bg-[#e8e2d9]/20 rounded-xs overflow-hidden flex-shrink-0">
                            <img
              ...
              {step === 'shipping' && (
                <div className="space-y-6 text-left">
                  <p className="text-xs text-[#4a4a4a] font-light leading-relaxed italic mb-4">
                    Kindly share your shipment coordinates. Premium ground shipping is complimentary for orders exceeding $150.
                  </p>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        />
                        {formErrors.zip && (
                          <p className="text-red-500 text-[10px] mt-1">{formErrors.zip}</p>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-6 text-left">
                  <div className="bg-[#e8e2d9]/40 p-4 rounded-sm mb-4">
                    <p className="text-[11px] text-[#4a4a4a] leading-relaxed flex items-start">
                      ...
                      <span>
                        Your shipping is routed to <strong>{shippingForm.city}, {shippingForm.zip}</strong>. Next, provide authorization. This is a fully secure, client-side demo sandbox.
                      </span>
                    </p>
                  </div>
                  ...
                  <div className="space-y-5">
                    <div>
                      ...
                      {formErrors.cardNum && (
                        <p className="text-red-500 text-[10px] mt-1">{formErrors.cardNum}</p>
                      )}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        />
                        {formErrors.cardCvc && (
                          <p className="text-red-500 text-[10px] mt-1">{formErrors.cardCvc}</p>
                        )}
                      </div>
                    </div>
                  </div>
              ...
              {step === 'completed' && (
                <div className="h-full flex flex-col items-center justify-center text-center py-6 text-[#222222]">
                  ...
                  <p className="text-xs text-[#4a4a4a] font-sans font-light tracking-wide mt-2 max-w-[280px]">
                    We’ve acknowledged your skincare collection. A confirmation email and tracking link have been dispatched.
                  </p>
                    ...
                    <div className="space-y-2">
                      {cartItems.map(item => (
                        <div key={item.product.id} className="flex justify-between text-xs text-[#222222]">
                          <span>{item.product.name} <span className="text-[#4a4a4a] font-mono">x{item.quantity}</span></span>
            ...
            {/* Static calculations & Sticky checkout triggers */}
